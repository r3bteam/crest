...
client.on('message', async function(message) {
    ...
    // const nomatch = "**<:MxNo:460268184218632222> You've to be in the same voice channel!**"
    const yt = "<:MxYT:473204932099440640>"
...
if(mess.content.startsWith(prefix+"search")) {
    ...
    message.channel.send(`**<:MxYT:473204932099440640> Search Results for \`\`${args}\`\`**`,{embed: {
